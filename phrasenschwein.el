;;; phrasenschwein.el --- Bypass that mental block when writing your papers. -*- lexical-binding: t -*-
...
;; Homepage: https://github.com/nashamri/phrasenschwein
...
(defvar phrasenschwein--all-phrases
      (ht
       ...
       (:cat2 (ht (:title "Ein Üerblick über die vergangene und gegenwätige Geschichte des Studiums von X")
                  (:items (list
                           (ht (:id 13)
       ...
       (:cat3 (ht (:title "Skizzierung der möglichen Zukunft von X")
                  (:items (list
                           (ht (:id 24)
                               (:template "Im nächsten [{1}] ist mit einem [{2}] Anstieg der X")
                               (:choices '(("Jahrzehnten" "Jahr")("erheblichen" "signifikant" "deutlichen"))))
                           (ht (:id 25)
                               (:template "In den [{1}] Jahren wird sich die X [{2}]")
                               (:choices '(("nächsten" "kommenden")("wahrscheinlich" "vorraussichtlich" "vermutlich"))))
                           ;(ht (:id 26)
                            ;   (:template "Within the next few years, X is [{1}] to become an important component in ...")
                             ;  (:choices '(("set" "destined" "likely"))))
                           (ht (:id 26)
                               (:template "An [{1}] des letzten Jahrhunderts läßt sich [{2}],")
                               (:choices '(("der Geschichte" "dem Forschungstand" "der Entwicklung" )("ablesen" "zeigen" "darstellen"))))
                           (ht (:id 27)
                               (:template "[{1}] wird sich die X ...")
                               (:choices '(("Innerhalb der nächsten zehn Jahre" "Im nächsten Jahr" "In naher Zukunft"))))
                           (ht (:id 28)
                               (:template "X wird [{1}] ein Thema sein, das ...")
                               (:choices '(("zwansläufigs" "bald" "in naher Zukunft" "unumgänglich"))))))))
       (:cat4 (ht (:title "Hinweis auf die Wissenslücke und mögliche Einschränkungen")
                  (:items (list
                           (ht (:id 29)
       ...
       (:cat6 (ht (:title "Erläuterung der wichtigsten Begriffe in Ihrem Fachgebiet")
                  (:items (list
                           (ht (:id 71)
       ...
       (:cat7 (ht (:title "Erläutern Sie, wie Sie die Terminologie und Akronyme in Ihrer Arbeit verwenden werden")
                  (:items (list
                           (ht (:id 86)
       ...
       (:cat8 (ht (:title "Die Struktur der Arbeit darstellen - was enthalten ist und was nicht")
                  (:items (list
                           (ht (:id 97)
       ...
       (:cat9 (ht (:title "Einen allgemeinen Üerblick ﾃｼber die Literatur der Vergangenheit bis zur Gegenwart geben")
                  (:items (list
                           (ht (:id 109)
                           ...
                           (ht (:id 122)
                               ...
                               (:choices '(("yet" "however"))))))))
       (:cat10 (ht (:title "Überprüfung der bisherigen Literatur")
                   (:items (list
                            (ht (:id 123)
       ...
       (:cat11 (ht (:title "Überprüfung der nachfolgenden und neueren Literatur")
                   (:items (list
                            (ht (:id 130)
       ...
       (:cat12 (ht (:title "Erläuter, was bestimmte Autoren gesagt haben")
                   (:items (list
                            (ht (:id 141)
       ...
       (:cat13 (ht (:title "Positive Aspekte der Arbeit anderer erwähnen")
                   (:items (list
                            (ht (:id 154)
       ...
       (:cat14 (ht (:title "Hervorhebung von Einschränkungen früherer Studien - Autoren nicht namentlich genannt")
                   (:items (list
                            (ht (:id 158)
       ...
       (:cat15 (ht (:title "Hervorhebung von Einschränkungen früherer Studien - namentlich genannte Autoren")
                   (:items (list
                            (ht (:id 172)
       ...
       (:cat16 (ht (:title "Die Meinung anderer benutzen, um Ihre Kritik an der Arbeit eines anderen zu rechtfertigen")
                   (:items (list
                            (ht (:id 190)
       ...
       (:cat19 (ht (:title "Beschreiben der verwendeten Materialien und deren Herkunft")
                   (:items (list
                            (ht (:id 216)
       ...
       (:cat20 (ht (:title "Berichterstattung über die verwendete Software")
                   (:items (list
                            (ht (:id 225)
       ...
       (:cat21 (ht (:title "Durchgefhrte Anpassungen beschreiben")
                   (:items (list
                            (ht (:id 232)
       ...
       (:cat23 (ht (:title "Erklären, warum Sie diese Methode gewhält haben.")
                   (:items (list
                            (ht (:id 253)
       ...
       (:cat24 (ht (:title "Erläutern der Vorbereitung von Proben, Lsungen usw. .")
                   (:items (list
                            (ht (:id 262)
       ...
       (:cat25 (ht (:title "Erläuterung des Auswahlverfahrens für Proben, Untersuchungen usw.")
                   (:items (list
                            (ht (:id 270)
       ...
       (:cat30 (ht (:title "Skizzierung alternativer Ansätze")
                   (:items (list
                            (ht (:id 318)
       ...
       (:cat31 (ht (:title "Erläutern Sie, wie Sie Ihre Ergebnisse erhalten haben")
                   (:items (list
                            (ht (:id 322)
       ...
       (:cat36 (ht (:title "Behauptung, dass Ihre Ergebnisse frühere Erkenntnisse bestätigen")
                   (:items (list
                            (ht (:id 369)
                            ...
                            (ht (:id 378)
                                ...
                                (:choices '(("share" "have"))))))))
       (:cat37 (ht (:title "Behauptung, dass Ihre Ergebnisse im Gegensatz zu früheren Erkenntnissen stehen")
                   (:items (list
                            (ht (:id 379)
       ...
       (:cat39 (ht (:title "Vorsicht bei der Interpretation der Ergebnisse ausdrücken")
                   (:items (list
                            (ht (:id 400)
       ...
       (:cat42 (ht (:title "Unerwünschte oder unerwartete Ergebnisse erläutern und begründen")
                   (:items (list
                            (ht (:id 428)
       ...
       (:cat43 (ht (:title " Uerwnschte oder unerwartete Ergebnisse minimieren")
                   (:items (list
                            (ht (:id 447)
       ...
       (:cat44 (ht (:title "Meinungen und Wahrscheinlichkeiten ausdrücken")
                   (:items (list
                            (ht (:id 461)
       ...
       (:cat49 (ht (:title "Mögliche Anwendungen und Implikationen Ihrer Arbeit skizzieren")
                   (:items (list
                            (ht (:id 508)
       ...
       (:cat54 (ht (:title "Übergnge schaffen, auf ein neues Thema hinweisen")
                   (:items (list
                            (ht (:id 575)
       ...
       (:cat55 (ht (:title "Rückwärts- und Vorwrärts verweisen im Beitrag")
                   (:items (list
                            (ht (:id 578)
       ...
       (:cat56 (ht (:title "Auf das Forschungsziel zurückverweisen")
                   (:items (list
                            (ht (:id 585)
                                (:template "Wie in der Einleitung [{1}], war unser Hauptziel, ...")
                                (:choices '(("erläutert wurde" "erwähnt" "dargestellt wurde"))))
                            (ht (:id 586)
       ...
       (:cat57 (ht (:title "Außerhalb des Papiers referenzieren")
                   (:items (list
                            (ht (:id 590)
...
;; The next two functions (phrasenschwein--ht-get* and
;; phrasenschwein--ht-select-keys) are taken from the excellent package ht.el
...
(defun phrasenschwein--ht-get* (table &rest keys)
...
for the final key, which may return any value."
  (if (cdr keys)
      (apply #'phrasenschwein--ht-get* (ht-get table (car keys)) (cdr keys))
    (ht-get table (car keys))))

(defun phrasenschwein--ht-select-keys (table keys)
...
(defun phrasenschwein--replace-placeholders (tmp choices)
  (s-replace-all `(("{1}" . ,(s-join "/" (car choices)))
                   ("{2}" . ,(s-join "/" (cadr choices)))
                   ("{3}" . ,(s-join "/" (cl-caddr choices))))
                 tmp))

(defun phrasenschwein--prompt-categories (phrases)
  (ht-map (lambda (k _) (phrasenschwein--ht-get* phrases k :title))
          phrases))

(defun phrasenschwein--prompt-items (cat &optional phrases)
  (unless phrases (setq phrases phrasenschwein--all-phrases))
  (mapcar (lambda (h)
           (cons (phrasenschwein--replace-placeholders
                   (ht-get h :template)
                   (ht-get h :choices))
            (ht-get h :id)))
         (phrasenschwein--get-items cat phrases)))

(defun phrasenschwein--filter-item (cat id &optional phrases)
  (unless phrases (setq phrases phrasenschwein--all-phrases))
  (let* ((items (phrasenschwein--get-items cat phrases))
         (match (car (-filter (lambda (i)
                                (equal (ht-get i :id) id))
                              items))))
       match))

(defun phrasenschwein--get-cat (res &optional phrases)
  (unless phrases (setq phrases phrasenschwein--all-phrases))
...
(defun phrasenschwein--get-items (cat &optional phrases)
  (unless phrases (setq phrases phrasenschwein--all-phrases))
  (phrasenschwein--ht-get* phrases cat :items))

(defun phrasenschwein--gen-cats-keywords (s e)
  (let* ((i (-iterate '1+ s (- e (1- s))))
         (cats (mapcar (lambda (c)
                         (concat ":cat" (number-to-string c))) i)))
    (mapcar 'intern-soft cats)))

(defun phrasenschwein--insert (phrases)
  (let* ((res (completing-read "Choose a category: "
                               (phrasenschwein--prompt-categories phrases) nil t))
         (cat (phrasenschwein--get-cat res phrases))
         (items (phrasenschwein--prompt-items cat))
         (id (cdr (assoc (completing-read "Choose a phrase: "
                                          items nil t)
                         items)))
         (item (phrasenschwein--filter-item cat id))
...
(defun phrasenschwein--insert-by-section (section &optional phrases)
  (unless phrases (setq phrases phrasenschwein--all-phrases))
  (let ((cats '()))
    (cond ((equal section :abstract) (setq cats '(:cat1 :cat2 :cat4 :cat5)))
          ((equal section :intro) (setq cats (phrasenschwein--gen-cats-keywords 1 16)))
          ((equal section :review) (setq cats (concatenate 'list '(:cat4) (phrasenschwein--gen-cats-keywords 9 16))))
          ((equal section :methods) (setq cats (phrasenschwein--gen-cats-keywords 17 30)))
          ((equal section :results) (setq cats (phrasenschwein--gen-cats-keywords 29 40)))
          ((equal section :discussion) (setq cats (phrasenschwein--gen-cats-keywords 35 45)))
          ((equal section :conclusion) (setq cats (phrasenschwein--gen-cats-keywords 45 51)))
          ((equal section :acknowledgments) (setq cats '(:cat52)))
          (t (setq cats (phrasenschwein--gen-cats-keywords 1 57))))
    (phrasenschwein--insert (phrasenschwein--ht-select-keys phrases cats))))

;;;###autoload
(defun phrasenschwein ()
  "Insert a phrase from a list of academic phrases by topic."
  (interactive)
  (phrasenschwein--insert phrasenschwein--all-phrases))

;;;###autoload
(defun phrasenschwein-by-section ()
  "Insert a phrase from a list of academic phrases by the paper section."
  (interactive)
  (let* ((sections '(("Zusammenfassung" . :abstract)
                     ("Einführung" . :intro)
                     ("Literaturische Rezension" . :review)
                     ("Methoden" . :methods)
                     ("Ergebnisse" . :results)
   ...
   (phrasenschwein--insert-by-section sec)))

(provide 'phrasenschwein)
;;; phrasenschwein.el ends here
